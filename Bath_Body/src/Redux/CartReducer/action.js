...
export const addtocart = async ({ item, dispatch}) => {
       ...
       return axios({
         url: "https://rainy-scissors.onrender.com/cart",
         method: "post",
         data: {
          img:item.img,
          Price:item.Price,
     ...
     export const getCart = async (dispatch) => {
      // console.log('cal')
        ...
        try {
          let res = await axios.get("https://rainy-scissors.onrender.com/cart");
      ...
      export const deleteitem =(id)=>(dispatch) => {
        console.log(id);
        return (
          axios.delete(`https://rainy-scissors.onrender.com/cart/${id}`)
          .then((res)=>{
            dispatch({
