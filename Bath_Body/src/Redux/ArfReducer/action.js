...
export const getData = () => (dispatch) => {
  ...
  return axios({
    url:'https://rainy-scissors.onrender.com/shop_body',
    method:'GET'
  }).then((res)=>{
...
export const getDataSingle=(id)=>(dispatch)=>{
  dispatch(getData_req());
  return axios({
    url:`https://rainy-scissors.onrender.com/shop_body/${id}`,
    method:'GET'
  }).then((res)=>{
...
export const getData1=()=>(dispatch)=>{
  dispatch(getData_req());
  return axios({
    url:'https://rainy-scissors.onrender.com/Moisturizers',
    method:'GET'
  }).then((res)=>{
    dispatch(getData_success(res.data));
  }).catch((err)=>{
...
export const getData2 = () => (dispatch) => {
  dispatch(getData_req());
  return axios({
    url: "https://rainy-scissors.onrender.com/candle",
    method: "GET",
  })
    .then((res) => {
      dispatch(getData_success(res.data));
...
export const getData3 = () => (dispatch) => {
  dispatch(getData_req());
  return axios({
    url: "https://rainy-scissors.onrender.com/newFragrance",
    method: "GET",
  })
    .then((res) => {
      dispatch(getData_success(res.data));
...
export const getData2candle = (dispatch, value) => {
  dispatch(getData_req());
  return axios
    .get(`https://rainy-scissors.onrender.com/candle?_sort=price&_order=${value}`)
    .then((r) => {
...
export const getData2soap = (dispatch, value) => {
  dispatch(getData_req());
  return axios
    .get(`https://rainy-scissors.onrender.com/shop_body?_sort=price&_order=${value}`)
    .then((r) => {
      dispatch(updateDataAsc(r.data));
    })
    .catch((error) => {
...
export const getData2fragrance = (dispatch, value) => {
  dispatch(getData_req());
  return axios
    .get(`https://rainy-scissors.onrender.com/newFragrance?_sort=price&_order=${value}`)
    .then((r) => {
      dispatch(updateDataAsc(r.data));
    })
    .catch((error) => {
...
export const getData2moisturizers = (dispatch, value) => {
  dispatch(getData_req());
  return axios
    .get(`https://rainy-scissors.onrender.com/Moisturizers?_sort=price&_order=${value}`)
    .then((r) => {
      dispatch(updateDataAsc(r.data));
    })
    .catch((error) => {
